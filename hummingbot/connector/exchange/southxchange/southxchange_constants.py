...
# Base URL
REST_URL = "https://market.southxchange.com/api/{}"
WSS_URL = "wss://market.southxchange.com/api/{}"

PUBLIC_API_VERSION = "v4"
PRIVATE_API_VERSION = "v4"

# Public API endpoints or SouthXchangeClient function
...
# Private API endpoints or SouthXchangeClient function
ACCOUNTS_PATH_URL = "/account"
MY_TRADES_PATH_URL = "/myTrades"
ORDER_PATH_URL = "/order"
SouthXchange_USER_STREAM_PATH_URL = "/userDataStream"
...
RATE_LIMITS = [
    ...
    RateLimit(limit_id=SNAPSHOT_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
              linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT, 100),
                             LinkedLimitWeightPair(RAW_REQUESTS, 1)]),
    RateLimit(limit_id=SouthXchange_USER_STREAM_PATH_URL, limit=MAX_REQUEST, time_interval=ONE_MINUTE,
              linked_limits=[LinkedLimitWeightPair(REQUEST_WEIGHT, 2),
                             LinkedLimitWeightPair(RAW_REQUESTS, 1)]),
