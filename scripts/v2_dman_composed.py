    ...
    config_v1 = DManV1Config(
        ...
        order_levels=[
            OrderLevel(
                ...
                order_refresh_time=60 * 30,
                cooldown_time=15,
                triple_barrier_conf=triple_barrier_conf_top,
            ),
            OrderLevel(
                level=1,
                side=TradeType.BUY,
                order_amount_usd=Decimal("50"),
                spread_factor=Decimal(5.0),
                order_refresh_time=60 * 30,
                cooldown_time=15,
                triple_barrier_conf=triple_barrier_conf_bottom,
            ),
            OrderLevel(
                level=2,
                side=TradeType.BUY,
                order_amount_usd=Decimal("50"),
                spread_factor=Decimal(8.0),
                order_refresh_time=60 * 15,
                cooldown_time=15,
                triple_barrier_conf=triple_barrier_conf_bottom,
            ),
            OrderLevel(
        ...
        candles_config=[
            CandlesConfig(connector="xeggex", trading_pair=trading_pair, interval="3m", max_records=1000),
        ],
        leverage=25,
        natr_length=21,
    )
