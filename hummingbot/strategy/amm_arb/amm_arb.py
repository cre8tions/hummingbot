        ...
        for arb_proposal in arb_proposals:
            ...
            for arb_side in (arb_proposal.first_side, arb_proposal.second_side):
                ...
                self.notify_hb_app_with_timestamp(
                    f"{side:>4} {arb_side.market_info.market.display_name:<10} {arb_side.market_info.base_asset:>10} {arb_side.amount:>.8f} @ "
                    f"{arb_side.order_price:<.8f}   Total: ${arb_side.amount * arb_side.order_price:>.8f}"
                )
