...
class SouthXchangeAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
                 auth: SouthXchangeAuth,
                 trading_pairs: List[str],
                 connector: 'SouthXchangeExchange',
                 api_factory: WebAssistantsFactory,
                 domain: str = CONSTANTS.DEFAULT_DOMAIN):
        super().__init__()
        self._auth: SouthXchangeAuth = auth
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        SouthXchange does not require any channel subscription.
    ...
    async def _get_listen_key(self):
        ...
        try:
            data = await rest_assistant.execute_request(
                url=web_utils.public_rest_url(path_url=CONSTANTS.SouthXchange_USER_STREAM_PATH_URL, domain=self._domain),
                method=RESTMethod.POST,
                throttler_limit_id=CONSTANTS.SouthXchange_USER_STREAM_PATH_URL,
