...
from hummingbot.connector.derivative.xt_perpetual import (
    xt_perpetual_constants as CONSTANTS,
    xt_perpetual_utils,
    xt_perpetual_web_utils as web_utils,
)
...
if TYPE_CHECKING:
    from hummingbot.connector.derivative.xt_perpetual.xt_perpetual_derivative import XtPerpetualDerivative


class XtPerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    def __init__(
        self,
        trading_pairs: List[str],
        connector: 'XtPerpetualDerivative',
    ...
    async def listen_for_subscriptions(self):
        ...
        tasks_future = None
        try:
            linear_trading_pairs, non_linear_trading_pairs = xt_perpetual_utils.get_linear_non_linear_split(
                self._trading_pairs
            )
