...
class XeggexAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def _subscribe_channels(self, ws: WSAssistant):
        ...
        try:
            ...
            payload = {"method": CONSTANTS.WS_METHOD_SUBSCRIBE_TRADES, "params": {"symbol": symbol}}
            subscribe_trade_request: WSJSONRequest = WSJSONRequest(payload=payload)

            payload = {"method": CONSTANTS.WS_METHOD_SUBSCRIBE_ORDERBOOK, "params": {"symbol": symbol, "limit": 100}}
    ...
    async def _parse_trade_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        if "result" not in raw_message:
            ...
            trade_message = XeggexOrderBook.trade_message_from_exchange(raw_message, {"trading_pair": trading_pair})
